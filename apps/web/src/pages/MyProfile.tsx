    ...
    <Layout>
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 text-slate-900">
        ...
        <form onSubmit={handleSave} className="space-y-6 rounded-3xl border border-slate-200/90 bg-white p-8 shadow-apple-sm">
          {success && (
            <div className="flex items-center gap-2 rounded-2xl bg-emerald-50 border border-emerald-200 p-4 text-sm text-emerald-800 font-medium">
              <Check className="h-5 w-5 text-emerald-600" /> Profile updated successfully!
            </div>
          )}

          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2 font-display">
